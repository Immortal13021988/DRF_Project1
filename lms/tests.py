...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(title="Введение", course=self.course, owner=self.user)
...
class SubscriptionTestCase(APITestCase):
    ...
    def test_subscribed(self):
        ...
        self.assertTrue(Subscription.objects.filter(course_sub=self.course.pk, user_sub=self.user.pk).exists())
